      ...
      <div>
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col xl:flex-row justify-between mb-6">
            <div className="flex flex-col w-full xl:w-[50%] gap-8">
              <input
                type="text"
                name="nomeCompleto"
                placeholder="Seu nome completo*"
                className="bg-input w-full xl:w-[675px] h-[50px] rounded pl-4"
            ...
            <div className="mt-8 xl:mt-0 w-full xl:w-[45%] flex flex-col gap-6">
              <textarea
                name="mensagem"
                placeholder="Sua mensagem aqui:"
                className="w-full xl:w-[580PX] h-full bg-input rounded p-4"
